<section id="landing-intro">
    ...
    <div class="row">
      <div class="col-sm-3"></div>
        ...
        <a style="margin-bottom: 5px" class="btn-info btn-block btn reg" href="https://2014.foss4g.org/schedule/sessions/">Watch the Recordings.</a><br>';              <a class="btn reg  btn-block" style="margin-bottom: 5px" href="/map-gallery">View the Map Gallery</a><br>
